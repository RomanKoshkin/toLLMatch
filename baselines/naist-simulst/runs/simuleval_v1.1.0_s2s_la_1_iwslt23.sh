...
if [ $tgt_l == "de" ]; then
  ...
  agent=${SCRIPT_ROOT}/simulst/agents/v1.1.0/s2s_la_1_iwslt23.py
...
simuleval_log_dir_name=speech_to_speech/${ts}.${ckpt}.${who}.${tgt_l}.LA${la_n}-chunk${chunk_size}-beam${beam}_1_iwslt23
