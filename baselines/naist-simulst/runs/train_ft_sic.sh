...
CONF_NAME=st-langid-interconnection-freeze-ft.yaml
export WANDB_NOTES="multi,langid,interconnect,5ave,FT-SIC"
...
#TMP finetune_from_model=${SAVE_DIR}/${WANDB_NAME}/ckpts/checkpoint_ave5.pt
base_update_freq=16
max_update=12_000
save_interval_updates=200
validate_interval_updates=200
export WANDB_NAME=${WANDB_NAME}/from_ave5,freeze
...
cmd="fairseq-hydra-train
  ...
  dataset.train_subset=train_sic
  dataset.valid_subset=dev_sic
