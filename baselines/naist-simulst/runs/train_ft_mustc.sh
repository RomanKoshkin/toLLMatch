...
CONF_NAME=st-langid-interconnection-mustc-freeze-ft.yaml
export WANDB_NOTES="from_ave5,mustc,lr2.5e-05,freeze"
...
export WANDB_NAME=${WANDB_NAME}/from_ave5,mustc,freeze,lr2.5e-05
