...
# SimulEval settings
who=test # [tst-COMMON, toy, toy.1]
evaldir=${ROOT}/data/eval_data/si/en-${tgt_l}
...
simuleval_log_dir_name=speech_to_speech/${ts}.${ckpt}.${who}.${tgt_l}.alpha${attn_threshold}-chunk${chunk_size}-beam${beam}-frame${frame_num}_3_accent
