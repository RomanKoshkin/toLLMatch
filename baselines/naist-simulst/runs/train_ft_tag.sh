...
CONF_NAME=st-langid-interconnection-tagged-freeze-ft-upsampling
...
#TMP finetune_from_model=${SAVE_DIR}/${WANDB_NAME}/ckpts/checkpoint_best.pt
finetune_from_model=${SAVE_DIR}/${WANDB_NAME}/ckpts/checkpoint_ave5.pt
base_update_freq=16
max_update=12_000
save_interval_updates=800  # default=200
validate_interval_updates=800  # default=200
export WANDB_NAME=${WANDB_NAME}/from_ave5,tagged,freeze,lr2.5e-05,upsampling
