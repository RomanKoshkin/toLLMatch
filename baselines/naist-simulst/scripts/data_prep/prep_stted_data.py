...
class STTED(Dataset):
    ...
    LANGUAGES = ["de"]
    SPLITS = ["train", "dev2010", "tst2010",
        "tst2011", "tst2012", "tst2013", "tst2014", "tst2015"]

    def __init__(self, root: str, lang: str, split: str) -> None:
        assert split in self.SPLITS and lang in self.LANGUAGES
        wav_root, txt_root = Path(root) / "wav", Path(root) / "parallel"
...
def process(args):
    ...
    for lang in STTED.LANGUAGES:
        cur_root = out_root / f"en-{lang}"
        ...
        if generate_zip:
            ...
            for split in STTED.SPLITS:
                print(f"Fetching split {split}...")

                dataset = STTED(root.as_posix(), lang, split)
        ...
        for split in STTED.SPLITS:
            ...
            if args.append_lang_id:
                manifest["tgt_lang"] = []
            dataset = STTED(args.data_root, lang, split)
